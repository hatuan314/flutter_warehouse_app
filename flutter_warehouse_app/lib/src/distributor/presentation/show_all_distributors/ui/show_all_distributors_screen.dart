...
import 'package:flutterwarehouseapp/src/distributor/presentation/show_all_distributors/bloc/distributor_bloc.dart';
import 'package:flutterwarehouseapp/src/distributor/presentation/show_all_distributors/ui/widgets/widgets.dart';
    ...
    if (state is DistributorLoadingState)
      ...
      return ListView.builder(
          ...
          itemBuilder: (context, index) {
            DistributorEntity distributorEntity = state.allDistributors[index];
            return DistributorsListItemWidget(distributorEntity);
          });
    else
      return Container(
